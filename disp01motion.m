%
% This function plots the wall motion for a specific point on the 
% dispersion relation for a linear infinite one-sided compliant wall.  
%
%

s = 2;			% The first or second root of 'c'?
k = 50; 		% The range of k values to plot
dispsolv
